...
| **2. .htaccess Protected Folders & Files** | Easy | No | No (no roles) | No | Folder requires username/password popup | Easiest setup<br>No coding | Ugly popup<br>No operator/supervisor logic |
